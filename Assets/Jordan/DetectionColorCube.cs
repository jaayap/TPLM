...
public class DetectionColorCube : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (state == State.red && other.GetComponent<Renderer>().material.name == "Red")
            {
                manager.red = true;
            }
            else if (state == State.green && other.GetComponent<Renderer>().material.name == "Green")
            {
                manager.green = true;
            }
            else if (state == State.blue && other.GetComponent<Renderer>().material.name == "Blue")
            {
                manager.blue = true;
            }
        }
